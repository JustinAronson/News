    ...
    <div className="App">
      ...
      <div class="max-w-2xl p-8">
          ...
          <form onSubmit={handleSubmit}>   
              ...
              <div class="relative">
                  <div class="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none mb-12">
                ...
                <div className="button-section">
                    ...
                    >Add</button>
                    <button type="submit" 
                    class="text-white absolute right-2.5 bottom-2.5 bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 mb-12">
                      Submit</button>
                </div>
